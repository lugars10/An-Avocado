class NodeObject
{
    ...
    hide()
    {
        if(this.isShown)
        {
            ...
            if(typeof this.image !== "undefined"){this.image.parentNode.removeChild(this.image); }
            this.isShown = false;
        }
    }
    ...
    show()
    {
        if(!this.isShown)
        {
            ...
            if(typeof this.image !== undefined){document.body.appendChild(this.image);}
            this.isShown = true;
        }
    }
    ...
    rotate(angle)
    {
        //if(typeof this.image === "undefined"){return 0;}
