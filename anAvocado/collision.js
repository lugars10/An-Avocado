class CollisionSystem
{
    ...
    {
        let collide = false; 
        if(kineticP1 < staticP1 && staticP1 < kineticP2){collide = true;}
        else if(kineticP1 < staticP2 && staticP2 < kineticP2){collide = true;}
        else if(kineticP1 == staticP1 && kineticP2 == staticP2){collide = true;}
        else if(kineticP1 < staticP1 && staticP2 < kineticP2){collide = true;}
        else if(staticP1 < kineticP1 && kineticP2 < staticP2){collide = true;}
